...
<div class="container-form">
    ...
    <form action="{{ route('user.register') }}" method="POST">
        ...
        <label for="email">
            Digite seu e-mail
            <input class="input" type="email" name="email" id="email" placeholder="exemplo@exemplo.com">
        </label>
        ...
        <label for="confirmed_password">
            Confirme sua senha
            <input class="input" type="password" name="confirmed_password" id="confirmed_password" placeholder="•••••••••••••">
        </label>

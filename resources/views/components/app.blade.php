...
<body style="overflow-x: hidden">
    ...
    <footer class="p-4 sm:p-6 bg-[#000000]" style="margin-top:120px;">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="{{ asset('img/logo.png') }}" class="" alt="FlowBite Logo" />
                </a>
            </div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li class="mb-4">
                            <a href="{{ route('project.index', ['type' => 'manga']) }}"
                                class="hover:underline">Mangas</a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('project.index', ['type' => 'manwha']) }}"
                                class="hover:underline">Manwhas</a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('project.index', ['type' => 'novel']) }}"
                                class="hover:underline">Novels</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{ date('Y') }} <a
                    href="{{ route('project.index') }}" class="hover:underline">Ninjaga™</a>. Todos os direitos
                reservados.
            </span>

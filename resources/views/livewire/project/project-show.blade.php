                    ...
                    <div class="w-3/4 h-[350px] overflow-x-scroll grid grid-cols-3 gap-6 p-2">
                        @foreach($chapters as $chapter)
                            <div wire:click="viewChapter({{$chapter->id}})"
                                 class="group h-16 bg-white hover:bg-gray-100 border border-gray-300 dark:border-none dark:bg-[#222222] dark:hover:bg-[#0B0B0B] rounded-md w-full flex flex-col gap-1 p-2 text-center transition ease-in cursor-pointer">
